...
import projectFilesRemote from '@deepseek-ai/dsh-host-project-files/remote'
...
export type { ProjectFileContent, ProjectFileEntry, ProjectFileListing } from '@deepseek-ai/dsh-host-project-files/types'
export type {} from '@deepseek-ai/dsh-commands/remote'
export type {} from '@deepseek-ai/dsh-file-reference/remote'
export type {} from '@deepseek-ai/dsh-goal/remote'
export type {} from '@deepseek-ai/dsh-host-plugin-inventory/remote'
export type {} from '@deepseek-ai/dsh-host-project-files/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, projectFilesRemote, messageFeedbackRemote, sessionReferencesRemote,
    ]) {
